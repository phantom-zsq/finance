...
# -------------------common start-------------------
basic_df = pd.read_sql_query('select ts_code from stock_basic where list_date<\'20210101\' and market is not null and ts_code>=\'603227.SH\' order by ts_code', engine)
