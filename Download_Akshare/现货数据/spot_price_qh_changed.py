...
def __get_item_of_spot_price_qh() -> pd.DataFrame:
    ...
    r = requests.get(url,verify='/Users/admin/PycharmProjects/finance/Download_Akshare/现货数据/_.99qh.com.pem')
...
def __get_token_of_spot_price_qh() -> str:
    ...
    r = requests.get(url, headers=headers, verify='/Users/admin/PycharmProjects/finance/Download_Akshare/现货数据/_.fx168api.com.pem')
...
def spot_price_qh(symbol: str = "螺纹钢") -> pd.DataFrame:
    ...
    r = requests.get(url, params=params, headers=headers, verify='/Users/admin/PycharmProjects/finance/Download_Akshare/现货数据/_.fx168api.com.pem')
    data_json = r.json()
