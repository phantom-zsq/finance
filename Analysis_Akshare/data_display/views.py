    ...
    try:
        with connection.cursor() as cursor:
            ...
            cursor.execute("select "
                           ...
                           " ",(trade_date,trade_date,trade_date,trade_date,trade_date,trade_date,trade_date,trade_date,trade_date,trade_date,current_workday,current_workday,trade_date,trade_date,trade_date,trade_date,current_workday))
...
def monitor(request):
    ...
    # 查询今日、昨日数据（调用内部工具函数）
    today_data_list = query_option_data(sql_template, [pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,current_workday,current_workday,pre_workday,pre_workday,pre_workday,pre_workday,current_workday])
    yesterday_data_list = query_option_data(sql_template, [pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday,pre_workday])
